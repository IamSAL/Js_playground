...
CanvasDisplay.prototype.clearDisplay = function() {
  if (this.level.status == "won"){
    this.cx.fillStyle = "rgba(255, 215, 0, 0.5)";
    document.body.style.backgroundColor="rgba(255, 215, 0, 0.5)";
  }
    ...
    img.addEventListener("load",()=>{
      this.cx.drawImage(img, 0, 0,  window.innerWidth, window.innerHeight)
    })
    
    this.cx.fillStyle = "rgba(251, 181, 50, 0.5)";
    //document.body.style.backgroundColor="rgba(52, 166, 251,0.5)";
