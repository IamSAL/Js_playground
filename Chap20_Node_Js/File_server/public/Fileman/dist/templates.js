...
function getTemplateExpanded(data) {
    ...
    if (data.type == "Directory") {
        return `
<tr class="file-item" data-type="dir" data-link="${data.link}" data-name="${data.name}">
                                <td>
...
`
    ...
    else
    {
        ...
        return `<tr class="file-item" data-type="file" data-link="${data.link}" data-name="${data.name}">
                                <td>
                                    <label class="checkbox">
                                        <input type="checkbox">
                                        <span class="checkbox-text"></span>
